...
//
//	@RequestMapping(value = "/reg.sh")
//	public ModelAndView save(@RequestParam("id") String id, @RequestParam("password") String password,
//			@RequestParam("password2") String password2, @RequestParam("birth") int birth) {
//		ModelAndView mv = new ModelAndView();
