...
<body>
	...
	<table class="type09" width="1000" height="70" border="1">
		<thead>
			<tr>
				<th width="25%" align="center" scope="cols"><a
					href="finance.do">재무재표보기</a></th>
	...
	<table border="1" width="1000">
		<tr>
			<td width="360" align="center">
				...
				</table> <!-- <table border="1" height="180" width="250"> --> <%-- <input type="hidden" name="idx" value="${idx}"> --%>
				...
				<table class="type09">
					<tbody border="1" width="250">
						<tr>
							<th scope="row" width="125" align="center"><a
								href="confirm.do?idx=${idx}">승인</a></th>
							<th scope="row" width="125" align="center"><a
								href="confirmdelete.do?idx=${idx}">거부</a></th>
						</tr>
					</tbody>
				</table> <!-- <table border="1" width="250"> --> <!-- <tr><td width="250" align="center"> -->
				<%-- <a href="confirm.do?idx=${idx}">승인</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; --%>
				<%-- <a href="confirmdelete.do?idx=${idx}">취소</a> --%> <!-- </td></tr> -->
				<!-- </table> -->

			</td>
			<td width="360">
				<!-- <table border="1" height="30" width="360" align="center"> --> <!-- <tr><td height="30" align="center" width="100">작성자</td> -->
				<!-- <td align="center" width="70">물품</td> --> <!-- <td align="center" width="70">수량</td> -->
				<!-- <td align="center" width="60">가격</td> --> <!-- <td align="center" width="60">상태</td> -->
				<!-- </tr> --> <!-- </table> -->
				...
				<table class="type09">
					...
					<c:forEach var="result" items="${result}">
						...
						<tbody border="1" height="30" width="590" align="center">
							<tr onclick="document.location.href='list.do?idx=${result.idx}'">
								...
								<c:if test="${count > 0}">
									...
									<c:if test="${param.pageNum > 1}">
										<button type="button" class="btn btn-primary btn-xs"
											onclick='location.href="/list.do?pageNum=1"'>처음</button>
									</c:if>
									<c:if test="${ startPage > 10 }">
										<button type="button" class="btn btn-primary btn-xs"
											onclick='location.href="/list.do?pageNum=${startPage - 5}"'>이전</button>
									</c:if>
										...
										<c:forEach var="i" begin="${startPage}" end="${pageCount}">
											<c:if test="${param.pageNum == i}">
												<button type="button" class="btn btn-success btn-xs"
													onclick='location.href="/list.do?pageNum=${i}"'>${i}</button>
											</c:if>
											<c:if test="${param.pageNum != i}">
												<button type="button" class="btn btn-primary btn-xs"
													onclick='location.href="/list.do?pageNum=${i}"'>${i}</button>
									...
									<c:if test="${endPage < pageCount}">
										...
										<button type="button" class="btn btn-primary btn-xs"
											onclick='location.href="/list.do?pageNum=${startPage + 5}"'>다음</button>
									</c:if>
									<c:if test="${param.pageNum < pageCount}">
										<button type="button" class="btn btn-primary btn-xs"
											onclick='location.href="/list.do?pageNum=${pageCount}"'>끝</button>
									</c:if>
								</c:if>
							</div>
						</td>
