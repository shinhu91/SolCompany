...
<tr><td height="30" align="center" >직  급</td><td align="center"><tf:select name="rank" 부장="부장" chief="과장" employee="사원"></tf:select></td></tr>
<tr><td height="30" align="center" >주문물품</td><td align="center"><tf:select name="buy" 책상="책상" chair="의자"></tf:select></td></tr>
<tr><td height="30" align="center" >수량</td><td align="center"><tf:select name="count" one="1" two="2" three="3" ></tf:select></td></tr>
<tr><td height="30" align="center" >이유</td><td align="center"><tf:select name="reason" 신규주문="신규주문" replace="기존물품마모"></tf:select></td></tr>
</table>
<table width="250">
